...
(function () {
    ...
    angular.module('myApp.directives')
        ...
        .directive('ghVisualization', ['d3service', function (d3service) {
            
            // constants
            var d3 = d3service,   // the whole d3 object from factory
                margin = 20,
                width = 960,
                ...
                link : function (scope, element, attrs) {
                    ...
                    scope.$watch('val', function (newVal, oldVal) {
                        ...
                        var n = newVal.length,      // number of layers
                            ...
                            y2 = function (d) {
                                return d.y * height / mz;   // or `my` not rescale
                            };
                        ...
                        // set a watch on 'grouped' to switch between views
                        scope.$watch('grouped', function (newVal, oldVal) {
                            
                            // ignore first call which happens before we even
                            // have data from the Github API
                            if (newVal === oldVal) {
                                return;
                            }
                            if (newVal) {
